...
func TestHybridAsSearchService_MapsFinalScoreToSearchResult(t *testing.T) {
	...
	svc := application.NewHybridAsSearchService(repo, embedder, domain.NewTuningSettings(0.5, domain.DefaultBM25K1, domain.DefaultBM25B))
...
func TestHybridAsSearchService_PropagatesError(t *testing.T) {
	svc := application.NewHybridAsSearchService(&fakeSQLRepo{}, &fakeEmbedder{}, domain.NewTuningSettings(0.5, domain.DefaultBM25K1, domain.DefaultBM25B))
...
func TestHybridAsSearchService_PropagatesRepoError(t *testing.T) {
	svc := application.NewHybridAsSearchService(&erroringSQLRepo{}, &fakeEmbedder{}, domain.NewTuningSettings(0.5, domain.DefaultBM25K1, domain.DefaultBM25B))
