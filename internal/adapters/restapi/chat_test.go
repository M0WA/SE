...
func TestHandleChat_EndpointNotConfigured(t *testing.T) {
	...
	svc := application.NewChatService(
		...
		&fakeChatCompleter{}, nil, nil, nil, nil, application.VisionConfig{Settings: nil, InternalAPIKey: ""})
	h, cookie := chatAuthedHandler(t, svc)
	rec := postChat(t, h, cookie, map[string]interface{}{
		"messages": []map[string]string{{"role": "user", "content": "hi"}},
	})
...
func TestHandleChat_ServiceError(t *testing.T) {
	svc := application.NewChatService(
		...
		&fakeChatCompleter{err: errors.New("upstream exploded")}, nil, nil, nil, nil, application.VisionConfig{Settings: nil, InternalAPIKey: ""})
	h, cookie := chatAuthedHandler(t, svc)
	rec := postChat(t, h, cookie, map[string]interface{}{
		"messages": []map[string]string{{"role": "user", "content": "hi"}},
	})
...
func TestHandleChat_TokenUsageBreakdown(t *testing.T) {
	...
	svc := application.NewChatService(
		...
		servers, &fakeMCPToolProvider{}, nil, nil, application.VisionConfig{Settings: nil, InternalAPIKey: ""})
	h, cookie := chatAuthedHandler(t, svc)
	rec := postChat(t, h, cookie, map[string]interface{}{
...
func TestHandleChat_UserCustomPromptReachesChatOptions(t *testing.T) {
	...
	svc := application.NewChatService(
		&fakeChatEndpointStore{endpoint: domain.ChatEndpoint{Enabled: true}},
		&fakeChatCompleter{answer: "plain answer"}, nil, nil, nil, nil, application.VisionConfig{Settings: nil, InternalAPIKey: ""})
...
func TestHandleChat_UserIDReachesChatOptionsForPersonalMCPServers(t *testing.T) {
	...
	svc := application.NewChatService(
		&fakeChatEndpointStore{endpoint: domain.ChatEndpoint{Enabled: true}},
		&fakeChatCompleter{answer: "plain answer"}, nil, provider, nil, userMCPServers, application.VisionConfig{Settings: nil, InternalAPIKey: ""})
	h, cookie := chatAuthedHandlerWithUser(t, svc, store, store.users[0])
	rec := postChat(t, h, cookie, map[string]interface{}{
		"messages": []map[string]string{{"role": "user", "content": "hi"}},
	})
...
func TestHandleChat_FileAccessTokenReachesMCPEnv(t *testing.T) {
	...
	svc := application.NewChatService(
		&fakeChatEndpointStore{endpoint: domain.ChatEndpoint{Enabled: true}},
		&fakeChatCompleter{answer: "plain answer"}, servers, provider, nil, nil, application.VisionConfig{Settings: nil, InternalAPIKey: ""})
	h, cookie := chatAuthedHandlerWithUser(t, svc, store, store.users[0])
	rec := postChat(t, h, cookie, map[string]interface{}{
		"messages": []map[string]string{{"role": "user", "content": "hi"}},
	})
...
func TestHandleChat_UserAgentFromOpSettingsReachesMCPEnv(t *testing.T) {
	...
	svc := application.NewChatService(
		...
		}}, servers, provider, nil, nil, application.VisionConfig{Settings: nil, InternalAPIKey: ""})
...
func TestHandleChat_AgentIDFromRequestReachesChatOptions(t *testing.T) {
	...
	svc := application.NewChatService(
		...
		&fakeChatCompleter{answer: "plain answer"}, nil, nil, agents, nil, application.VisionConfig{Settings: nil, InternalAPIKey: ""})
	h, cookie := chatAuthedHandler(t, svc)
	rec := postChat(t, h, cookie, map[string]interface{}{
		"messages": []map[string]string{{"role": "user", "content": "hi"}},
...
func TestHandleChat_WebSearchOverrideFalse_DeactivatesGatedServer(t *testing.T) {
	...
	svc := application.NewChatService(
		...
		&fakeChatCompleter{answer: "no need to search"}, servers, provider, nil, nil, application.VisionConfig{Settings: nil, InternalAPIKey: ""})
	h, cookie := chatAuthedHandler(t, svc)
	rec := postChat(t, h, cookie, map[string]interface{}{
		"messages":   []map[string]string{{"role": "user", "content": "tell me about cats"}},
		"web_search": false,
...
func TestHandleChat_NoToolResultsWhenNoToolCall(t *testing.T) {
	...
	svc := application.NewChatService(
		&fakeChatEndpointStore{endpoint: domain.ChatEndpoint{Enabled: true}},
		&fakeChatCompleter{answer: "no marker here"}, servers, provider, nil, nil, application.VisionConfig{Settings: nil, InternalAPIKey: ""})
	h, cookie := chatAuthedHandler(t, svc)
	rec := postChat(t, h, cookie, map[string]interface{}{
		"messages": []map[string]string{{"role": "user", "content": "hi"}},
	})
